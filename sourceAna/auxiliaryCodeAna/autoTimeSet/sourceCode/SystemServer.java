...
import com.android.server.usr.services.UsrLedService;
import com.android.server.usr.services.UsrGpioService;
...
public final class SystemServer {
    ...
    private void startOtherServices() {
		...
		UsrLedService usrLedService = null;
		UsrGpioService usrGpioService =  null;
...
//            disableLocation = true;
        ...
        if (mFactoryTestMode != FactoryTest.FACTORY_TEST_LOW_LEVEL) {
            ...
            if (!disableNetwork) {
                ...
                /*UsrLedService*/
                Slog.i(TAG, "Context.USR_LED_SERVICE");
                usrLedService = new UsrLedService(context);
                ServiceManager.addService(Context.USR_LED_SERVICE, usrLedService);

                /*UsrGpioService*/
                Slog.i(TAG, "UsrGpioService");
                usrGpioService = new UsrGpioService(context);
                ServiceManager.addService(Context.USR_GPIO_SERVICE, usrGpioService);
                Trace.traceEnd(Trace.TRACE_TAG_SYSTEM_SERVER);
